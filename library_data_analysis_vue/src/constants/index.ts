...
export const STAT_CARDS_CONFIG = [
  { i18nKey: 'overview.totalFlow', key: 'total_borrows', icon: 'book-open', accent: '#6366f1' },
  { i18nKey: 'overview.registeredReaders', key: 'total_readers', icon: 'users', accent: '#8b5cf6' },
  ...
  { i18nKey: 'overview.libraryRenewals', key: 'reh_count', icon: 'refresh', accent: '#8b5cf6' },
  ...
  { i18nKey: 'category.categoryCount', key: 'total_categories', icon: 'tag', accent: '#6366f1' }
]

export const READER_STAT_CARDS = [
  { i18nKey: 'reader.totalReaders', key: 'total_readers', accent: '#6366f1' },
  { i18nKey: 'reader.monthActive', key: 'month_active', accent: '#8b5cf6' },
...
export const BOOK_STAT_CARDS = [
  { i18nKey: 'book.totalItems', key: 'total_items', accent: '#6366f1' },
  { i18nKey: 'book.monthItems', key: 'month_items', accent: '#8b5cf6' },
...
export const BORROW_STAT_CARDS = [
  { i18nKey: 'borrow.totalActions', key: 'total_actions', accent: '#6366f1' },
  { i18nKey: 'borrow.totalBorrows', key: 'total_borrows', accent: '#8b5cf6' },
